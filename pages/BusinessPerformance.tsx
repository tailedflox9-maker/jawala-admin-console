...
import { Box, Typography, Chip, Avatar, Grow, Paper } from '@mui/material';
import { TrendingUp, Phone, WhatsApp, Share, Visibility, EmojiEvents } from '@mui/icons-material';
    ...
    return (
      <Box sx={{ display: 'grid', gap: 3, gridTemplateColumns: { xs: '1fr', md: 'repeat(3, 1fr)' }, mb: 4 }}>
        {topThree.map((business, index) => (
          <Grow key={business.id} in timeout={500 + index * 100}>
            <Paper
          ...
          <CardContent sx={{ p: 3 }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
              <Box>
                ...
                <Typography variant="body2" color="text.secondary">
                  Raw data breakdown per business ID
                </Typography>
              </Box>
              <Chip 
